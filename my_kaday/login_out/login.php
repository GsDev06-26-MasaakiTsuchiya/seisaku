...
.navbar-default {
background-color: rgba(61,136,232,0.8);
border-color:;
...
<div class="row features_item_row">
  ...
  <div class="col-sm-5 intro_item">
    <img class="intro_img img-responsive img-rounded" src="./img/multichat.jpg" alt="">
...
<div class="row functions_item_row">
  ...
  <div class="col-sm-2">
    ...
    <p class="intro_text">カレンダーで空き時間を選択するだけで候補者に面接候補日時を送信。googleカレンダーとの連携。</p>
  </div>
  <div class="col-sm-2">
    <img class="intro_img img-responsive img-rounded" src="./img/images.jpeg" alt="">
...
<div class="row functions_item_row">
  ...
  <div class="col-sm-2">
    ...
    <p class="intro_text">様々な通知をslackに送信。</p>
  </div>
  <div class="col-sm-2">
    <img class="intro_img img-responsive img-rounded" src="./img/images.jpeg" alt="">
...
<section class="plice_lists">
  ...
  <div class="row plice_row">
    <div class="col-sm-1"></div>
      <div class="col-sm-10 features_title">
        <h4 class="text-center muryo bg-primary">無料でもずっと使える<br>クラウド採用管理・ウェブ面接システム　Smart Interview</h4>
    </div>
    <div class="col-sm-1"></div>
  </div>
  <div class="row plice_row">
