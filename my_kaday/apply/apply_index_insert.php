...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO corp_apply(id, corp_name, corp_name_en, main_title_text, main_lead_text, main_photo, corp_logo
)VALUES(NULL, :corp_name, :corp_name_en, :main_title_text, :main_lead_text, :main_photo, :corp_logo)");
