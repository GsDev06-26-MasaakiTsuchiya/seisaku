...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT interviewee_name FROM interviewee_info,interview where interview.id= :interview_id AND interviewee_info.id = interview.interviewee_id");
...
<div class="container-fruid">
  <div class="row">
      ...
      <h4 class="col-xs-2 pg text-center">1,規約同意</h4><h4 class="col-xs-2 pg text-center gray">2,動作検証</h4><h4 class="col-xs-2 pg text-center gray">3,面接日時選択</h4><h4 class=" col-xs-2 pg text-center gray">4,返信完了
      </h4>
      <div class="col-xs-2 hidden-xs"></div>
  </div>
  <div class="row">
    ...
    <div class="col-xs-8 thanks_message">
      <h3 class="text-center"><?=$res["interviewee_name"]?>様</h3>
      <p class="text-left">
...
<div class="container-fruid">
  <div class="row">
    ...
    <p>
    ウェブ面接を実施するにあたり smartinterviewというサービスを利用します。<br>
    大変お手数ですが、利用に先立ちsmartInterviewの利用規約（以下）をご確認くださいますようお願い致します。</p>
    </div>
    <div class="col-xs-2 hidden-xs"></div>
  </div>
</div>
