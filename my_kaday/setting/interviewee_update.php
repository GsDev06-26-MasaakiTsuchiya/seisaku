...
//３．データ登録SQL作成
$stmt = $pdo->prepare("UPDATE interviewee_info SET interviewee_name=:interviewee_name,interviewee_name_kana=:interviewee_name_kana,job_post_id=:job_post_id,birthday=:birthday,sex=:sex,mail=:mail,postcode=:postcode,address=:address,github=:github,portfolio=:portfolio,motivation=:motivation,resume0=:resume0,resume1=:resume1,resume2=:resume2 WHERE id=:id");
